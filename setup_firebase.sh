...
then
    projectEnv="dev"
    flutterfire.bat configure --project=$projectName --ios-bundle-id="com.fhrstic.task.dev" --android-package-name="com.fhrstic.task.dev" --android-app-id="com.fhrstic.task.dev" --platforms="android,ios" --yes
else
    flutterfire.bat configure --project=$projectName --platforms="android,ios" --yes
fi
